...
//! to the appropriate values in the [`magick`] module (magick.rs file).
//! 
//!
//! # Structure Overview
...
//! `graphics`. The main.rs file right now includes a living example of how you can do that.
//! 
//! ## (Picture) Graphics Engine
//! In the class's C and Python templates, you'll use just functions and arrays to model your engine. The Python version is more C-styled.
//! However, here you will be using structs, methods, enums, and so on.
//! 
...
//!         - The `Write`r passed will be wrapped around a BufWriter, so you should pass in a `File` directly.
//!         - There is a variant that does not buffer the output. Check the module for more details.
//! 
...
//! 
//! # Get Ready
//! You should be comfortable poking around this documentation. Reading docs is an invaluable skill you should gain in programming.
//! 
...
//! 
//! After you implement that, you should run main.rs to see an example. Feel free to explore other functionalities 
//! ([`draw_line_degrees`] and [`Turtle`]) that are provided to you for free! 
//!
...
/// Re-export common types to be used in drawing.
pub mod prelude {
    pub use crate::{
        color::Rgb,
        ppm::{Ppm, PpmBuilder},
